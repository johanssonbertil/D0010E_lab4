...
/**
 * The GUI class.
 * Creates a game window and displays the game board as well as buttons and a message. 
 * Also hosts anonymous listeners for the buttons and game.
 */
...
public class GomokuGUI implements Observer{
	...
	/**
	 * The constructor
	 * Creates a window to display buttons and the game and a message.
	 * Adds listeners for the buttons and game.
	 * 
	...
	public GomokuGUI(GomokuGameState g, GomokuClient c){
		...
		messageLabel.setText(Integer.toString(GomokuMain.port));
		...
		layout.putConstraint(SpringLayout.NORTH, messageLabel, 6, SpringLayout.SOUTH, connectButton);
		...
		int side = gameGridPanel.getUnitSize() * (g.getGameGrid().getSize()+1);
		frame.setSize(side+5, (int) Math.round(side*1.3));
